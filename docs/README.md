...
- [Clean Code Resources](#clean-code-resources)
  - [Intro](#intro)
  - [General](#general)
    - [Books](#books)
    - [Podcasts](#podcasts)
...
- [Clean Code concepts adapted for Golang and an example how to apply](https://github.com/Pungyeon/clean-go-article)
- [Clean code in Golang](https://github.com/Pungyeon/clean-go)
...
- [Andreas Lundblad Java Style Guidelines](https://cr.openjdk.java.net/~alundblad/styleguide/index-v6.html)
- [Google Java Style Guide](https://google.github.io/styleguide/javaguide.html)
- [Oracle Code Conventions for the Java Programming Language](https://www.oracle.com/java/technologies/javase/codeconventions-introduction.html)
